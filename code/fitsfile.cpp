...
int FitsFile::copyHDU()
{
 ...
 int FitsFile::readTable()
 {
        ...
        std::auto_ptr<FITS> pInfile(new FITS("/home/lazza/software/FITS/CCfits/atestfil.fit",Read,hdus,false));
